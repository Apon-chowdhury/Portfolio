...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-[#050505] text-gray-300 overflow-hidden font-sans selection:bg-[#DA291C] selection:text-white">
      ...
      {/* --- Main Content Area --- */}
      <main id="main-scroll" className="flex-1 h-full overflow-y-auto scroll-smooth bg-[#050505] relative pt-16 md:pt-0">
